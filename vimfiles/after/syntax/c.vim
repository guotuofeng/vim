...
"
" Changelog:
"   Myguo changed: add ifdef folding
...
" Operators
syn match cUserOperator	"\(<<\|>>\|[-+*/%&^|<>!=]\)="
syn match cUserOperator	"<<\|>>\|&&\|||\|++\|--\|->"
syn match cUserOperator	"[.!~*&%<>^|=,+-]"
syn match cUserOperator	"/[^/*=]"me=e-1
syn match cUserOperator	"/$"
syn match cUserOperator "&&\|||"
syn match cUserOperator	"[][]"

hi def link cUserOperator		Operator
...
" Copy from http://stackoverflow.com/questions/736701/class-function-names-highlighting-in-vim
" Highlight Class and Function names
syn match    cppUserScope    "::"
syn match    cppUserClass    "\w\+\s*::" contains=cppUserScope
syn match    cppCustomStlNamespace    "std::" contains=cppCustomScope

hi def link cUserFunction cFunction
hi def link cUserFunctionPointer cFunction
hi def link cppUserClass Structure
